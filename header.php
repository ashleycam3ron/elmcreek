...
<a class="navbar-brand" href="<?php echo esc_url( home_url() ) ?>" style="display: none;">
           	...
           	<div class="row">
			    <nav class="navbar navbar-default" role="navigation">
			        ...
			        <div class="collapse navbar-collapse navbar-ex1-collapse row">
						<div id="location" class="col-sm-4 col-sm-offset-1 top text-center">
							<h2>Located at</h2>
							<p class="geo">40º43'7'N / 99º22'31'W</p>
							<p>Central Nebraska along the <br/>Platte River Valley</p>
						</div>
						<div id="estb" class="col-sm-4 top text-center">
							<h2>Established</h2>
							<p>1866</p>
							<?php get_search_form(); ?>
						</div>
